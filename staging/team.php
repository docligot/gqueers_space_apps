...
<div class="w3-row">
	...
	<div class="w3-col l10">
		...
		<div class="w3-row" style="margin-left:20px">
				...
				<img src="../teamphotos/oscar.png" height="150px" width="200px">
				<h3 class="din">Miguel Oscar Castelo</h3>
				<p>Oscar is an associate data analytics consultant at CirroLytix with background in financial markets. He is passionate about data, analytics, investment strategies, and robust problem solving.</p>

				<img src="../teamphotos/tessa.jpg" height="150px" width="200px">
				...
				<img src="../teamphotos/hm.jpeg" height="150px" width="200px">
				<h3 class="din">Helen Mary Labao-Barrameda</h3>
				<p>Helen (also known as H) is an associate data consultant at CirroLytix. She is also a systems and geodetic engineer, web developer, technical writer, and data analyst. She has done projects ranging from GIS, infrastructure development roadmaps, web scraping, database development, systems administration, business intelligence reports, marketing automations, and demand forecasting.</p>
		</div>
		<footer>
