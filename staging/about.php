...
<div class="w3-row">
	...
	<div class="w3-col l10">
		...
		<div class="w3-padding">
			...
			<p>Instead of the traditional way, we nowcast GDP from the integration of night light (economic), covid-19 growth rate (health), mobility data (lockdown and human activity), and nitrogen dioxide (environment). The approach is multi-disciplinary and goes beyond the inclusion of typical economic indicators.</p>
