...
<div class="w3-row">
	...
	<div class="w3-col l10">
		...
		<div class="w3-padding">
			<p>Global Impact Detection using Emitted Light, Onset of Covid-19, and Nitrogen Dioxide<br>The odds of the pandemic to the economy are against us.<br>Let's beat the odds with satellite data using GIDEON's nowcast tool. </p>
